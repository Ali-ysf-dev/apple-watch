function Header() {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-0 px-4 sm:px-6">
      <header
        style={{
          width: "fit-content",
          borderRadius: "0 0 20px 20px",
          boxShadow:
            "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1), 0 10px 25px -5px rgba(0, 0, 0, 0.08)",
        }}
        className="flex items-center justify-center gap-16 px-6 lg:px-10 h-12 bg-white/80 backdrop-blur-xl border-b border-black/5"
      >
